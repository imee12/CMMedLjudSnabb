...
class TwoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //delay of 3 seconds to restart accel updates to prevent sound and vc overlap
        delay(3) {
...
//            case 0:
//                print("uno from two")
//                //                let vc : AnyObject! = self.storyboard!.instantiateViewControllerWithIdentifier("two")
//                //                self.showViewController(vc as! UIViewController, sender: vc)
//                // self.performSegueWithIdentifier("ToTwo", sender: self)
//                //
...
//            case 1:
//                print("dos from two")
//                let dosFromTwo = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("TwoViewController") as UIViewController
//                let appDelegate = (UIApplication.sharedApplication().delegate as! AppDelegate)
//                appDelegate.window?.rootViewController = dosFromTwo
//
//                // .instantiatViewControllerWithIdentifier() returns AnyObject! this must be downcast to utilize it
//                
//                self.presentViewController(dosFromTwo, animated: false, completion: nil)
//                
//                break
//                
//                //  ViewController(nibName: "Tw0ViewController", bundle: nil)
//                
//            case 2:
//                print("tres from two")
//                let tresFromTwo = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("ThreeViewController") as UIViewController
//                let appDelegate = (UIApplication.sharedApplication().delegate as! AppDelegate)
//                appDelegate.window?.rootViewController = tresFromTwo
//                
//                // .instantiatViewControllerWithIdentifier() returns AnyObject! this must be downcast to utilize it
//                
//                self.presentViewController(tresFromTwo, animated: false, completion: nil)
//                
//                break
//
//                break
